...
/* The broader carrier relationship registry: national, regional, and specialty carriers
   beyond the ~10 rich DRP profiles above. Profile fields (program, rep, dates, etc.) are
   synthesized deterministically from name+tier in app.js so the CRM tab holds ~100 carriers. */
window.HUB_DATA.carrierRoster = [
  { name: "Auto-Owners Insurance", tier: "National", territory: "Midwest, South" },
  { name: "The Hartford", tier: "National", territory: "National" },
  { name: "Kemper", tier: "National", territory: "National" },
  { name: "National General", tier: "National", territory: "National" },
  { name: "Safeco", tier: "National", territory: "National" },
  { name: "Amica Mutual", tier: "National", territory: "National" },
  { name: "MetLife Auto & Home", tier: "National", territory: "National" },
  { name: "Esurance", tier: "National", territory: "National" },
  { name: "Root Insurance", tier: "National", territory: "National" },
  { name: "Metromile", tier: "National", territory: "National" },
  { name: "Sentry Insurance", tier: "National", territory: "National" },
  { name: "Encompass Insurance", tier: "National", territory: "National" },
  { name: "Clearcover", tier: "National", territory: "National" },
  { name: "Lemonade", tier: "National", territory: "National" },
  { name: "Branch Insurance", tier: "National", territory: "National" },
  { name: "Openly", tier: "National", territory: "National" },
  { name: "Hippo Insurance", tier: "National", territory: "National" },
  { name: "The General", tier: "Specialty", territory: "National" },
  { name: "Dairyland", tier: "Specialty", territory: "National" },
  { name: "Bristol West", tier: "Specialty", territory: "National" },
  { name: "Foremost Insurance", tier: "Specialty", territory: "National" },
  { name: "GAINSCO", tier: "Specialty", territory: "South" },
  { name: "First Acceptance", tier: "Specialty", territory: "South" },
  { name: "Access Insurance", tier: "Specialty", territory: "South" },
  { name: "Safeway Insurance", tier: "Specialty", territory: "South" },
  { name: "Fred Loya Insurance", tier: "Specialty", territory: "Texas, West" },
  { name: "MAPFRE Insurance", tier: "Regional", territory: "Northeast" },
  { name: "Commerce Insurance", tier: "Regional", territory: "Massachusetts" },
  { name: "Arbella Insurance", tier: "Regional", territory: "New England" },
  { name: "Safety Insurance", tier: "Regional", territory: "Massachusetts" },
  { name: "Plymouth Rock Assurance", tier: "Regional", territory: "Northeast" },
  { name: "Vermont Mutual", tier: "Regional", territory: "New England" },
  { name: "Concord Group", tier: "Regional", territory: "New England" },
  { name: "MMG Insurance", tier: "Regional", territory: "New England" },
  { name: "Utica National", tier: "Regional", territory: "Northeast" },
  { name: "Merchants Insurance Group", tier: "Regional", territory: "Northeast" },
  { name: "NYCM Insurance", tier: "Regional", territory: "New York" },
  { name: "Preferred Mutual", tier: "Regional", territory: "New York" },
  { name: "Kingstone Insurance", tier: "Regional", territory: "New York" },
  { name: "Central Insurance", tier: "Regional", territory: "Northeast, Midwest" },
  { name: "Selective Insurance", tier: "Regional", territory: "Mid-Atlantic" },
  { name: "NJM Insurance", tier: "Regional", territory: "New Jersey, Pennsylvania" },
  { name: "Cure Auto Insurance", tier: "Regional", territory: "New Jersey, Pennsylvania" },
  { name: "Palisades Insurance", tier: "Regional", territory: "New Jersey" },
  { name: "Franklin Mutual", tier: "Regional", territory: "New Jersey" },
  { name: "High Point Insurance", tier: "Regional", territory: "New Jersey" },
  { name: "IFA Auto Insurance", tier: "Regional", territory: "New Jersey" },
  { name: "Penn National Insurance", tier: "Regional", territory: "Pennsylvania, Mid-Atlantic" },
  { name: "Donegal Insurance", tier: "Regional", territory: "Mid-Atlantic" },
  { name: "Erie Insurance", tier: "Regional", territory: "Mid-Atlantic, Midwest" },
  { name: "Rockingham Insurance", tier: "Regional", territory: "Virginia" },
  { name: "Virginia Farm Bureau", tier: "Regional", territory: "Virginia" },
  { name: "Cincinnati Insurance", tier: "Regional", territory: "Midwest" },
  { name: "Westfield Insurance", tier: "Regional", territory: "Midwest" },
  { name: "Grange Insurance", tier: "Regional", territory: "Midwest, South" },
  { name: "Hastings Mutual", tier: "Regional", territory: "Michigan" },
  { name: "Pekin Insurance", tier: "Regional", territory: "Illinois" },
  { name: "Frankenmuth Insurance", tier: "Regional", territory: "Michigan" },
  { name: "Motorists Mutual", tier: "Regional", territory: "Ohio" },
  { name: "Central Mutual", tier: "Regional", territory: "Ohio" },
  { name: "West Bend Mutual", tier: "Regional", territory: "Wisconsin" },
  { name: "SECURA Insurance", tier: "Regional", territory: "Midwest" },
  { name: "Acuity Insurance", tier: "Regional", territory: "Midwest" },
  { name: "Rural Mutual", tier: "Regional", territory: "Wisconsin" },
  { name: "EMC Insurance", tier: "Regional", territory: "Midwest" },
  { name: "Grinnell Mutual", tier: "Regional", territory: "Midwest" },
  { name: "IMT Insurance", tier: "Regional", territory: "Iowa" },
  { name: "Country Financial", tier: "Regional", territory: "Midwest" },
  { name: "Shelter Insurance", tier: "Regional", territory: "Midwest, South" },
  { name: "Cameron Mutual", tier: "Regional", territory: "Missouri" },
  { name: "Cornerstone National", tier: "Regional", territory: "Missouri" },
  { name: "Alfa Insurance", tier: "Regional", territory: "Alabama, South" },
  { name: "Southern Farm Bureau", tier: "Regional", territory: "South" },
  { name: "Georgia Farm Bureau", tier: "Regional", territory: "Georgia" },
  { name: "Cotton States Insurance", tier: "Regional", territory: "Georgia" },
  { name: "American National", tier: "Regional", territory: "South, Midwest" },
  { name: "Kentucky Farm Bureau", tier: "Regional", territory: "Kentucky" },
  { name: "Tennessee Farm Bureau", tier: "Regional", territory: "Tennessee" },
  { name: "North Carolina Farm Bureau", tier: "Regional", territory: "North Carolina" },
  { name: "Louisiana Farm Bureau", tier: "Regional", territory: "Louisiana" },
  { name: "Mississippi Farm Bureau", tier: "Regional", territory: "Mississippi" },
  { name: "Texas Farm Bureau", tier: "Regional", territory: "Texas" },
  { name: "Germania Insurance", tier: "Regional", territory: "Texas" },
  { name: "Home State County Mutual", tier: "Regional", territory: "Texas" },
  { name: "Mercury Insurance", tier: "Regional", territory: "West, California" },
  { name: "Wawanesa Insurance", tier: "Regional", territory: "California" },
  { name: "CSAA Insurance (AAA)", tier: "Regional", territory: "West" },
  { name: "Auto Club Group (AAA)", tier: "Regional", territory: "Midwest, Southeast" },
  { name: "Infinity Insurance", tier: "Regional", territory: "South, West" },
  { name: "Elephant Insurance", tier: "Regional", territory: "Mid-Atlantic" },
  { name: "Hallmark Insurance", tier: "Regional", territory: "South" }
];
